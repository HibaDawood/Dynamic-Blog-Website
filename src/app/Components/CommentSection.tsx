...
export default function CommentSection() {
 ...
 <form
  onSubmit={editingId ? saveEdit : addComment} className="mb-6">
 <input
 type="text"
 ...
 <button
 type="submit"
 className="bg-myDarkPr text-white px-4 py-2 rounded-md hover:bg-myDarkestPr"
 >
 ...
 className="bg-gray-200 text-gray-700 px-2 py-1 rounded-md text-sm mr-2 hover:bg-gray-300"
 >
 Edit
 </button>
 <button
