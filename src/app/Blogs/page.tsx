                ...
                <Image
                 ...
                 />
                  ...
                  <h2 className="text-2xl font-semibold text-myDarkestPr mb-3 -mt-1">
                    ...
                    <p className="leading-relaxed mb-10 line-clamp-2 font-medium">
                 It refers to the simulation of human intelligence in machines that are programmed to think, 
                ...
                <Image
                 ...
                 />
                  ...
                  <h2 className="text-2xl font-semibold text-myDarkestPr mb-3 -mt-1">
                    ...
                    <p className="leading-relaxed mb-10 line-clamp-3 font-medium">
                    AI in space enables advanced exploration, autonomous spacecraft operations, 
                    and efficient data analysis for cosmic discoveries.
                    </p>
                    <div className="flex items-center flex-wrap ">
                      <a 
                      href='/Blogs/Post5'
                ...
                <Image
                 ...
                 />
                  ...
                  <h2 className="text-2xl font-semibold text-myDarkestPr mb-3 -mt-1">
                    ...
                    <p className="leading-relaxed mb-10 line-clamp-3 font-medium">
                    AI in arts empowers creative expression by generating music, visual 
                    art, and storytelling while enhancing artistic innovation.
                    </p>
                    <div className="flex items-center flex-wrap ">
                      <a
                      href='/Blogs/Post6'
